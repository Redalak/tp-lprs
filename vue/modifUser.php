            ...
            <form action="../src/traitement/modifUser.php" method="post">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nom" class="form-control" required value="<?= htmlspecialchars($u->getNom()) ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Prénom *</label>
                        <input type="text" name="prenom" class="form-control" required value="<?= htmlspecialchars($u->getPrenom()) ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Email *</label>
                        <input type="email" name="email" class="form-control" required value="<?= htmlspecialchars($u->getEmail()) ?>">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="specialite" class="form-control" value="<?= htmlspecialchars($u->getSpecialite()) ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Matière</label>
                        <input type="text" name="matiere" class="form-control" value="<?= htmlspecialchars($u->getMatiere()) ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Poste</label>
                        <input type="text" name="poste" class="form-control" value="<?= htmlspecialchars($u->getPoste()) ?>">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label">Année promo</label>
                        <input type="number" name="annee_promo" class="form-control" min="0" value="<?= htmlspecialchars($u->getAnneePromo()) ?>">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Promo</label>
                        <input type="text" name="promo" class="form-control" value="<?= htmlspecialchars($u->getPromo()) ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">CV (lien/nom de fichier)</label>
                        <input type="text" name="cv" class="form-control" value="<?= htmlspecialchars($u->getCv()) ?>">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Motif partenariat</label>
                        <input type="text" name="motif_partenariat" class="form-control" value="<?= htmlspecialchars($u->getMotifPartenariat()) ?>">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Ref. entreprise</label>
                        <input type="number" name="ref_entreprise" class="form-control" min="0" value="<?= htmlspecialchars($u->getRefEntreprise()) ?>">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Ref. formation</label>
                        <input type="number" name="ref_formation" class="form-control" min="0" value="<?= htmlspecialchars($u->getRefFormation()) ?>">
                    </div>
                </div>
